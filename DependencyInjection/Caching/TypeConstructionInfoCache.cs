...
using DependencyInjection.Reflectors;
...
namespace DependencyInjection.Caching
{
    internal static class TypeConstructionInfoCache
    {
        ...
        private static TypeConstructionInfo Generate(Type type)
        {
            ...
            {
                var constructor = constructors.FirstOrDefault(c => Attribute.IsDefined(c, typeof(DependencyInjectionConstructorAttribute))); // Try to get a constructor that defines DependencyInjectionConstructor
